...
Запустите в терминале скрипт migrations.sh для создания базы данных
```
 ./migrations.sh
```
...
![image](https://github.com/user-attachments/assets/59ed3e91-d6d0-4c28-95c1-12d5dc48c711)
