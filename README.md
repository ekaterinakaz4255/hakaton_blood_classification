...
Решение:
	  ...
	  - Сохранение преобразованных данных в отдельные CSV-файлы и объединение в один суммарный CSV-файл.
...
### 6) Оформление интерфейса сервиса с помощью Streanlit с подключением БД SQlite3
