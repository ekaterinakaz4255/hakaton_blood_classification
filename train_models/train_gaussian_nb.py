...
model_output_path = "models/gaussian_nb.pkl"
...
# 4. Обучение модели GaussianNB с прогрессом
print("Обучение модели GaussianNB...")
model = GaussianNB()
...
if out_of_norm_results:
    ...
    with open("data/out_of_norm_results_gaussian_nb.json", "w") as f:
        json.dump(out_of_norm_results, f, indent=4)
    print("Отклонения сохранены в data/out_of_norm_results_gaussian_nb.json")

# 8. Сохранение предсказаний
X_test_cleaned = X_test.copy()
X_test_cleaned["Predicted ICD-10"] = y_pred
X_test_cleaned.to_csv("data/test_with_predictions_gaussian_nb.csv", index=False)

print("Обучение модели GaussianNB завершено!")
